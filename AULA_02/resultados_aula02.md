...
As respostas enviadas foram incorretas por não ter interpretado de forma certa os comandos dados.


# 2 - Detectado algum erro, qual seria a maneira mais correta de melhorar o resultado do algoritmo?
Inserindo mais dados e rótulos para uma melhor interpretação de comandos.


# 3 - Detalhe a função do LogisticRegression no algorítmo.
É uma função melhor usada para filtrar características de uma classe, utilizando 0 e 1, assim definindo qual a probabilidade de um frase pertencer a uma função especifica.


--- RESULTADOS 1 DO LAB 01 ---
